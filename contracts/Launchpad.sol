    ...
    AccessControlUpgradeable
{
    ...
    function buy(uint256 _buyAmount) public nonReentrant whenNotPaused {
        ...
        usdcToken.transferFrom(msg.sender, address(this), _buyAmount);
        ...
        emit TransferToken("buy-erc20", msg.sender, _sandoAmount, _buyAmount);
    }
    ...
    function buyWithAdmin(
        ...
        usdcToken.transferFrom(_buyer, address(this), _buyAmount);
